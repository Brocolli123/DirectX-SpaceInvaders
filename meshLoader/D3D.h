...
public:
  ...
  void ResetDepthBuffer() {   //Reset the Depth Buffer Stencil
    GetDeviceCtx().ClearDepthStencilView(mpDepthStencilView, D3D11_CLEAR_DEPTH | D3D11_CLEAR_STENCIL, 1.0f, 0);
    ...
    //HR(CreateDepthStencilState(&depthStencilDesc, &m_DepthStencilState));
    //GetDeviceCtx().OMSetDepthStencilState(m_DepthStencilState, 0);
  }
